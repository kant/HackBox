...
export const projects = [
  {
    ...
    json_needed_roles: JSON.stringify(["Developer", "Data Science"]),
  ...
  },
  {
    ...
    json_needed_roles: JSON.stringify(["Services", "Finance"]),
...
while (count--) {
  projects.push(Object.assign({}, projects[1], {
    ...
    json_needed_roles: JSON.stringify(sample(participantTypes, 3)),
    product_focus: sample(productTypes),
